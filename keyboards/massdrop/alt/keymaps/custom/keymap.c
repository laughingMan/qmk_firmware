...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______,                            DBG_FAC,                            MO(2),   _______, KC_HOME, KC_PGDN, KC_END   \
    ),
    [2] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, ALT(KC_T), \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, ALT(KC_K), \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, ALT(KC_B), \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, ALT(KC_G), \
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, ALT(KC_L)  \
    ),
    /*
    [X] = LAYOUT(
